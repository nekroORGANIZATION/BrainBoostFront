    ...
    return (
      <main className="min-h-screen bg-[url('/images/back.png')] bg-cover bg-top grid place-items-center px-6">
        <Card className="max-w-2xl">
          <h1 className="text-2xl font-extrabолд text-[#0F2E64]">Ти ще не викладач</h1>
      ...
      <section className="w-full max-w-screen-xl mx-auto px-4 md:px-6 mt-8 grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-6 pb-20">
        ...
        <Card>
          <div className="flex items-center justify-between">
            ...
            <Link href="/teacher/courses" className="text-[#1345DE] hover:underline text-sm">
              Всі курси →
            </Link>
          </div>
          ...
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
            <Card>
              ...
              <ul className="list-disc pl-5 mt-2 text-sm text-slate-700 space-y-1">
                <li>
                  Створи або доповни програму курсу в <b>Builder → Програма</b>.
                </li>
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                ...
                <Link href="/teacher/tests/edit" className="px-4 py-2 rounded-xl ring-1 ring-[#E5ECFF] bg-white hover:ring-[#1345DE] transition">
                  Відкрити конструктор тестів
                </Link>
                {!isCertified && (
