          ...
          <div>
            ...
            <div className="mt-4 flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
              <Link href="/student/courses" className="w-full sm:w-auto">
                <span className="block text-center rounded-2xl px-5 py-3 bg-white text-black shadow hover:shadow-md transition-shadow">
                  Продовжити навчання
                </span>
              </Link>
              <Link href="/courses" className="w-full sm:w-auto">
                <span className="block text-center rounded-2xl px-5 py-3 bg-indigo-600 text-white shadow hover:bg-indigo-700 transition">
                  Знайти нові курси
                </span>
              </Link>
            </div>
