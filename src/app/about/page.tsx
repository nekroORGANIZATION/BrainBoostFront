...
const founders: Founder[] = [
  {
    ...
    quote:
      '«Змінювати країну — це процес, у якому кожен крок важливий: нові знання — нові можливості.»',
    fb: '#',
    ig: '#',
    tg: '#',
  },
  {
    ...
    quote:
      '«Освіта — головний інструмент розвитку. Технології мають бути доступними кожному.»',
    fb: '#',
    ig: '#',
    tg: '#',
  },
  {
    ...
    quote:
      '«Ми створюємо середовище, де студент швидко бачить результат своєї праці.»',
    fb: '#',
    ig: '#',
    tg: '#',
  },
...
/* ======================== Стилі (DRY) ======================== */
const WRAP_1200 = 'mx-auto w-full max-w-[1200px] px-4 sm:px-6 lg:px-[118px]';
const CARD_WHITE_20 =
...
const SOCIAL_TILE =
  'grid h-12 w-12 sm:h-16 sm:w-16 place-items-center rounded-[15px] bg-white ring-1 ring-[#E5ECFF] shadow-[0_8px_24px_rgba(2,28,78,0.06)] hover:ring-[#1345DE] transition';
const CTA_BTN_PRIMARY =
  'inline-flex items-center justify-center rounded-[14px] bg-[#1345DE] px-5 py-3 text-white font-semibold hover:bg-[#0e2db9] transition text-base sm:text-lg';
const CTA_BTN_OUTLINE =
  'inline-flex items-center justify-center rounded-[14px] border border-[#1345DE] px-5 py-3 text-[#1345DE] font-semibold hover:bg-[#EEF3FF] transition text-base sm:text-lg';

/* ======================== Дрібні компоненти ======================== */
function Tile({ src, alt = '' }: { src: string; alt?: string }) {
  return (
    <div className="h-full w-full overflow-hidden rounded-[20px] border-[1.4px] border-[#1345DE]">
    ...
    <article className={CARD_WHITE_20}>
      <div className="flex items-start justify-between gap-4">
        <div className="min-w-0">
          <h3 className="truncate text-[18px] font-extrabold text-[#0F2E64]">
            {f.name}
          </h3>
          <p className="text-[12px] font-semibold text-[#5A78B4]">{f.title}</p>
        </div>
      ...
      <p className="mt-3 text-[17px] leading-[22px] text-slate-700">{f.quote}</p>
    </article>
  );
}
...
export default function AboutPage() {
  return (
    <main className="min-h-screen bg-[url('/images/back.png')] bg-top bg-cover">
        ...
        <div className="mx-auto w-full max-w-[1280px] px-4 sm:px-6">
          <div className="grid items-start gap-8 lg:grid-cols-2 lg:gap-6">
            ...
            <div className="max-w-xl lg:max-w-none">
              ...
              <p
                className="mt-4 max-w-[46ch] font-[Mulish] text-[18px] leading-[1.4] text-black sm:text-[20px] lg:text-[24px]"
              >
              ...
              <Link
                href="/courses"
                className={`${CTA_BTN_PRIMARY} mt-6 w-full max-w-[280px] sm:w-auto`}
              >
              ...
              <div className="mt-8 flex items-center gap-4">
                <div className="flex items-center">
                  <img
                    src="/images/ava1.png"
                    alt=""
                    className="block h-12 w-12 rounded-full sm:h-[70px] sm:w-[70px]"
                  />
                  <img
                    src="/images/ava2.png"
                    alt=""
                    className="block -ml-3 h-12 w-12 rounded-full sm:-ml-[25px] sm:h-[70px] sm:w-[70px]"
                  />
                  <img
                    src="/images/ava3.png"
                    alt=""
                ...
                <div className="font-[Mulish] text-black">
                  <div className="text-[18px] font-bold leading-[1.3] sm:text-[24px]">
                    2000+ Задоволенних
                  </div>
                  <div className="text-[18px] font-bold leading-[1.3] sm:text-[24px]">
                    відгуків від учнів
            ...
            <div className="mx-auto w-full max-w-[564px]">
              <div
                ...
                style={{
                  gridTemplateColumns: '1fr 0.78fr', // зберігає оригінальні пропорції (308/239≈0.78)
      ...
      {/* Засновники */}
      <section>
        <div className={`${WRAP_1200} pb-10 pt-10 md:pb-12 md:pt-12`}>
          <p className="text-center text-[15px] text-[#5A78B4] sm:text-[16px]">
            Знайомся ближче
          </p>
          <h2 className="mt-2 text-center text-[28px] font-extrabold leading-[1.25] text-[#0F2E64] sm:text-[32px] md:text-[36px]">
            Засновники Brainboost
          </h2>

          <div className="mt-6 grid grid-cols-1 gap-5 sm:mt-8 sm:grid-cols-2 md:grid-cols-3">
            {founders.map((f) => (
      ...
      <section className="pb-12">
        <div className={WRAP_1200}>
          <div className="rounded-[24px] bg-[#0D2B6B] p-5 text-white shadow-[0_12px_30px_rgba(2,28,78,0.18)] sm:p-6 md:p-8">
            <h3 className="text-[20px] font-extrabold sm:text-[22px] md:text-[24px]">
              Коротка історія Brainboost
            </h3>
            <p className="mt-3 leading-relaxed text-blue-100">
              BrainBoost було засновано у 2016 році як хаб і центр онлайн-курсів для
              дорослих і студентів. Ми робимо практичні навчальні програми з фокусом
              на результат. За цей час створили десятки курсів, провели сотні
              інтенсивів і допомогли тисячам студентів отримати першу роботу в
              актуальних напрямках. Наша мета — навчання без води, з чіткими кроками
              й підтримкою ментора.
            </p>

            <div className="mt-5 overflow-hidden rounded-[16px] ring-2 ring-blue-700 shadow-md">
      ...
      <section className="py-12 sm:py-16 lg:py-20">
        <div className="mx-auto w-full max-w-[1300px] px-4 sm:px-6 lg:px-[118px]">
          <div className="flex flex-col items-center gap-6 rounded-[24px] bg-white p-6 ring-1 ring-[#E5ECFF] shadow-[0_10px_30px_rgba(2,28,78,0.1)] sm:gap-8 sm:p-8 md:flex-row md:p-10">
            {/* Ліва частина */}
            <div className="flex-1">
              <h4 className="text-[22px] font-bold text-[#0F2E64] sm:text-[24px] md:text-[28px]">
                Шукаєш ефективні курси?
              </h4>
              <p className="mt-3 text-base leading-relaxed text-slate-700 sm:mt-4 sm:text-lg">
                У нас — практичні програми, живі заняття та мобільний доступ. Підвищуй
                кваліфікацію або знаходь першу роботу після курсу.
              </p>
              <div className="mt-5 flex w-full flex-col gap-3 sm:mt-6 sm:flex-row">
                <Link href="/courses" className={`${CTA_BTN_PRIMARY} w-full sm:w-auto`}>
                  Дивитися курси
                </Link>
                <Link href="/about" className={`${CTA_BTN_OUTLINE} w-full sm:w-auto`}>
                  Дізнатись більше
                </Link>
              </div>
            </div>
            ...
            {/* Права частина */}
            <div className="relative w-full overflow-hidden rounded-[20px] ring-2 ring-blue-700 shadow-md md:w-[300px]">
              <img
      ...
      <section className="py-8 sm:py-10">
        <div className={WRAP_1200}>
          <h5 className="text-center text-[21px] font-extrabold text-[#0F2E64] sm:text-[23px] md:text-[27px]">
            Слідкуй за нами у соцмережах
          </h5>
          <div className="mt-5 flex justify-center gap-3 sm:mt-6 sm:gap-6">
            {[LinkedInIcon, FacebookIcon, YouTubeIcon, InstagramIcon, TelegramIcon].map(
              (Icon, i) => (
...
function LinkedInIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-8 w-8 fill-[#1345DE] sm:h-11 sm:w-11" aria-hidden="true">
...
function YouTubeIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-8 w-8 fill-[#E11D48] sm:h-11 sm:w-11" aria-hidden="true">
...
function InstagramIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-8 w-8 fill-[#E1306C] sm:h-11 sm:w-11" aria-hidden="true">
...
function TelegramIcon() {
  return (
    <svg viewBox="0 0 24 24" className="h-8 w-8 fill-[#0EA5E9] sm:h-11 sm:w-11" aria-hidden="true">
...
export function IgIcon({ size = 20, className = 'text-[#1345DE]', title }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M12 7.5a4.5 4.5 0 1 1 0 11 4.5 4.5 0 0 1 0-11Z" />
