...
const CourseList = () => {
    ...
    const fetchUser = async () => {
        if (!token) return;
        try {
        const res = await axios.get('http://172.17.10.22:8000/courses/all/users/me/', axiosConfig);
        setUser({
            id: res.data.id,
    ...
    const fetchCategories = async () => {
        try {
        const res = await axios.get('http://172.17.10.22:8000/courses/all/categories/');
    ...
    const fetchLanguages = async () => {
        try {
        const res = await axios.get('http://172.17.10.22:8000/courses/all/?page=1&page_size=1000');
    ...
    const fetchCourses = async () => {
        ...
        const res = await axios.get('http://172.17.10.22:8000/courses/all/', {
            params,
            ...axiosConfig,
        });
    ...
    const handleDelete = async (courseId: number) => {
        if (!token) return;
        try {
        await axios.delete(`http://172.17.10.22:8000/courses/${courseId}/`, axiosConfig);
        fetchCourses();
        } catch (err) {
